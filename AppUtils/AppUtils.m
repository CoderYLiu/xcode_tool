...
+ (void)saveUUIDToKeyChain {
    KeychainItemWrapper *keychainItem = [[KeychainItemWrapper alloc] initWithAccount:@"com.xiaoxin.mrpudding" service:@"MrPudding" accessGroup:nil];
...
+ (NSString *)readUUIDFromKeyChain {
    KeychainItemWrapper *keychainItemm = [[KeychainItemWrapper alloc] initWithAccount:@"com.xiaoxin.mrpudding" service:@"MrPudding" accessGroup:nil];
...
+ (NSString *)getDeviceID {
    NSString *deviceID = [self readUUIDFromKeyChain];
    if ([deviceID isEqualToString:@""] || !deviceID) {
        [self saveUUIDToKeyChain];
        return [self readUUIDFromKeyChain];;
    } else {
        return deviceID;
    }
}
